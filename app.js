...
function loadHTMLEditor() {
    ...
    //mode mode
	//solarized_dark // dreamweaver // github
...
function chooseCSS() {
    var h = document.getElementById("htmlEditor");
    var c = document.getElementById("cssEditor");
    var j = document.getElementById("jsEditor");
